...
from utils.api import extract_trending_repos, transform_all_records
from utils.aws import get_boto3_session, push_data_to_s3, get_data_from_s3
from utils.rds import get_rds_connection, insert_into_rds
...
def github_api_to_s3(**context):
    ...
    Raw data is pushed into s3 bucket using the following sample format::
    "raw/trending-repos-2025-02-03.json"
    """
...
def transform_and_upload_data(**context):
    ...
    Raw data is pushed into s3 bucket using the following format::
    "transformed/trending-repos-2025-02-03.json"
    """
